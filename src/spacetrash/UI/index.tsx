...
export const SpaceTrashDesktop = () => {
  ...
  const [state, stateSetter] = useState<IState>(initialState);

  SpaceTrashGameSingleton.start()

  // useEffect(() => {
  //   return SpaceTrashGameSingleton.updateFromUI(state)
  // }, [state])
