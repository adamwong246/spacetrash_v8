...
import explorationBehaviors from "./behaviorPatterns/explore";
...
export class AiAgentComponent extends Component<any, any> {
  ...
  constructor(explorePattern: IExplore, entity: SpaceTrashEntity) {
    super();
  ...
  tick(game: SpaceTrash, delta: number) {
    explorationBehaviors[this.explorePattern](this, game, delta);
  }
