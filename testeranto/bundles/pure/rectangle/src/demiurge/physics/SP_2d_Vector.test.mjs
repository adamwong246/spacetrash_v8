...
// src/demiurge/physics/SP_2d_Vector.ts
var import_sat = __toESM(require_SAT(), 1);
var SP_2d_Vector = class extends import_sat.default.Vector {
  constructor(x, y) {
    super(x, y);
  }
  /**
   ...
   * @returns {SP_2d_Vector} This vector after scaling
   */
  multiply(scalar) {
    ...
    Suite.Default(
      "Testing an implementation of a 2d vector",
      {
        ...
        test7: Given.ByXAndY(
          ...
          [],
          [Then.rotate(1e-3, 5.001997499666875, -1.9949990008334166)],
          5,
          -2
        ),
        test8: Given.ByXAndY(
...
var SP_2d_Vector_test_default = Pure_default(null, spec, imp, interf);
export {
  SP_2d_Vector_test_default as default,
  imp,
  spec
};
